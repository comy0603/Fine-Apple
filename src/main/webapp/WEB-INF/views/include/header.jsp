                    ...
                    <div class="col-12 h-100">
                        <div class="main-menu h-100">
                            <nav class="navbar h-100 navbar-expand-lg">
                                <!-- Logo Area  -->
                                <a class="navbar-brand" href="/index.jsp"><img src="/resources/img/core-img/logo3.png" alt="Logo"></a>
                                ...
                                <div class="collapse navbar-collapse" id="medilifeMenu">
                                    ...
                                    <ul class="navbar-nav ml-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="/show/aboutUs">About Us</a>
                                        </li>
                                        <li class="nav-item">
                                        	<a class="nav-link" href="/show/product">Product</a>
                                        </li>
                                        <li class="nav-item dropdown">                                        
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="/show/fAq">FAQ</a>
                                                <a class="dropdown-item" id="qna" href="/board/list">Q&A</a>
                                            </div>
                                        </li>                                         
                                        <li class="nav-item">
										...
										%>
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">My Page</a>
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="/user/myInfo">My Info</a>
                                                <a class="dropdown-item" href="/user/myIot">IoT Info</a>
                                                <a class="dropdown-item" href="/reservation/reservation">Reservation</a>                                                
                                            </div>
                                        </li>
                                        <li class="nav-item">
