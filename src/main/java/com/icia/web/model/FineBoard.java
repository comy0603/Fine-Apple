...
public class FineBoard implements Serializable 
{
	...
	private FineBoardFile fineBoardFile;	//첨부파일
	...
	public FineBoardFile getFineBoardFile() {
		return fineBoardFile;
	}

	public void setFineBoardFile(FineBoardFile fineBoardFile) {
		this.fineBoardFile = fineBoardFile;
	}
