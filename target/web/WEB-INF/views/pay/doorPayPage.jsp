...
$(document).ready(function() {
	...
	$("#btnPay").on("click", function() {
        ...
        var radioBtn = $("input[name=doorService]:checked");
			...
			<form>
				<table class="table table-hover" style="text-align: center">
			  		...
			  		<tbody style="align-text:center">
			     		<tr>	              			
	              			<td><input type="radio" name="doorService" value="Fine-IoT50(door)"></td>
	              			<td>Fine-IoT50</td>
	              			<td>100</td>
	              			<td>500MB</td>
	            		</tr>	            	
	            		<tr>
	              			<td><input type="radio" name="doorService" value="Fine-IoT75(door)"></td>
	              			<td>Fine-IoT75</td>
	              			<td>7500</td>
	              			<td>750MB</td>
	            		</tr>
	            		<tr>
	              			<td><input type="radio" name="doorService" value="Fine-IoT100(door)"></td>
	              			<td>Fine-IoT100</td>
	              			<td>10000</td>
	              			<td>1.5GB</td>
	            		</tr>
	            		<tr>
	              			<td><input type="radio" name="doorService" value="Fine-IoT150(door)"></td>
	              			<td>Fine-IoT150</td>
	              			<td>14000</td>
	              			<td>4GB</td>
	            		</tr>
